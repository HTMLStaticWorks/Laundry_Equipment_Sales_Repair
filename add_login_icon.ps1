...
$pattern = '(?s)(<!-- RTL Toggle Button -->\s*<button class="btn-icon rtl-toggle-btn" title="Toggle LTR/RTL" aria-label="Toggle LTR/RTL" id="desktop-rtl-toggle">\s*<i data-lucide="arrow-left-right"></i>\s*</button>)'
